...
const foundersData = [
    ...
    },
    {
        ...
        description: [
            ...
            "Su dedicación a la calidad y su atención al detalle garantizan que cada sitio web que diseña sea una obra maestra."
        ],
        values: [
            {
                title: 'VISIONARIA CREATIVA',
                detail: 'Ella tiene una capacidad única para traducir la visión de una marca en una presencia digital cautivadora.'
            },
            {
            ...
            {
                title: 'CENTRADA AL CLIENTE',
                detail: 'Comprendiendo necesidades y objetivos de sus clientes, crea soluciones personalizadas que mejoran la experiencia del usuario e impulsan la participación.'
            }
        ],
        imageUrl: ailin,
        altText: "Imagen Ailin Navas",
        color: "#B365E1",
        specificStyles: {
            textAlign: "",
