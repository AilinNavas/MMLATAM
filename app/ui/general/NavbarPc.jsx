  ...
  return (
    <div className='hidden lg:flex bg-black h-20 items-center  px-3 py-12'>
      ...
      <div className='flex justify-around items-center cursor-pointer lg:w-3/5' >
        ...
        <span className='flex items-center text-base font-medium text-white'>¿Qué ofrecemos?
        ...
        <FlyoutLink href='/aboutUs' FlyoutContent={AboutUs} >
          <span className='flex items-center text-base font-medium text-white'>Acerca de nosotros
          </span>
        </FlyoutLink>
  ...
  return (
    <div className='w-[500px] flex h-40 bg-black p-6 cursor-pointer'>
      ...
      <div className='group flex flex-col justify-center ml-4 mx-auto w-2/3'>
        <h5 className='font-bold'>Team Leader</h5>
        <p className='py-2 font-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit illum.</p>
      </div>
      </Link>
    </div>
  )
