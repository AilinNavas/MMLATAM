  ...
  return (
    <div className='hidden lg:flex bg-black h-20 items-center  px-3 py-12'>
      ...
      <div className='flex justify-around items-center cursor-pointer lg:w-3/5' >
        <FlyoutLink href='/service' FlyoutContent={ServicesOptions}>
        <span className='flex items-center text-base font-medium text-white'>What we offer?
        ...
        <FlyoutLink href='/aboutUs' FlyoutContent={AboutUs} >
          <span className='flex items-center text-base font-medium text-white'>About Us
          </span>
        </FlyoutLink>
        <FlyoutLink href='/blog' FlyoutContent={Blog}  >
          <span className='flex items-center text-base font-medium text-white'>Blog
          </span>
        </FlyoutLink>
  ...
  return (
    <div className='w-[1000px] flex items-center h-40 bg-black p-6 cursor-pointer'>
      ...
      <div className='group flex flex-col w-1/4 mx-auto'>
        ...
        <p className='py-2 font-light'>Dominate Local Search Results with Expert Local SEO for Dental Practices</p>
      </div>
      ...
      <div className='group flex flex-col w-1/4 mx-auto'>
        ...
        <p className='py-2 font-light'>Elevate your dental practice with a website that attracts, engages, and converts</p>
      </div>
      ...
      <div className='group flex flex-col w-1/4 mx-auto'>
        ...
        <p className='py-2 font-light'>Transform Your Dental Practice with Proven Email Marketing Strategies </p>
      </div>

      {/* <div className='group flex flex-col w-1/4 mx-auto '>
        <h4 className='font-bold flex items-center text-white space-x-2'>
          <span className='left-0 w-1 h-8 rounded-full bg-[#FF7A00] group-hover:bg-[#f8b06c]' />
          <Link href="/service/consultancy">Consultoria</Link>
        </h4>
        <p className='py-2 font-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
      </div> */}
