  ...
  return (
    <div className='w-[100vw]'>
        ...
        <div className='relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8 mx-auto'>
          ...
          <p className={` ${archivo.className} mt-6 mx-auto text-center text-xl text-white sm:max-w-3xl`}>Dejanos la estrategia a nosotros</p>
          <div className='mt-5 max-w-sm mx-auto flex-col md:flex-row flex justify-center items-center md:mt-8 lg:px-4'>
            <Button bg={'bg-violet-500'} bgHover={'hover:bg-violet-900'} text={'Empezar hoy'} textColor={'text-white'} especif={'m-1 px-0'} />
